...
function add (name, text) {
  uniqID = data.length + 1;
  data.push({ name: name, text: text, uniqID: uniqID });
}
...
module.exports.add("Kimber", "I'm not a morning person.");
module.exports.add("Anna", "I'm not a morning person either.");
module.exports.add("Joe", "I loves puppies.");
